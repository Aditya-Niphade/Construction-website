              ...
              <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <ul className="navbar-nav position-absolute top-0 end-0 mt-3 me-5">
                    ...
                    authenticated && isAdmin ? (
                      <>
                        <li className="nav-item me-2">
                          <Link className="nav-link text-white " to="/first-ad">
                            Projects
                          </Link>
                        </li>
                        <li className="nav-item me-3">
                          <Link className="nav-link text-white" to="/careers-ad">
                            Careers
                          </Link>
                        </li>
                      </>
                  ...
                  < form className='d-flex'>
                    {authenticated ? (
                      <button type="button" onClick={handleLogout} class="btn btn-outline-primary text-white">Logout</button>
                    ) : (
                      <li className="nav-item">
