                                ...
                                <div className="carousel-item active ">
                                    <div className="row">
                                        ...
                                        >
                                            ...
                                            <br />
                                            <h5>
                                            The main objects of Vedanand Constructions is to carry on the business of building promoters, land developers, builders, contractor & all types of construction.
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="carousel-inner">
                                <div className="carousel-item active">
                                    <div className="row">
                                        ...
                                        <div className="col-4">
                                            <img
                                                src={require('../images/commercial5.png')}
                                                className="d-block w-100 shadow-lg p-1"
                                                alt="..."
                                            />
                                        </div>
                                        <div className="col-4">
                                            <img
                                                src={require('../images/commercial6.png')}
                                                className="d-block w-100 shadow-lg p-1"
                                                alt="..."
                                            />
                                        </div>
                                ...
                                <div className="carousel-item">
                                    <div className="row">
                                        <div className="col-4">
                                            <img
                                                src={require('../images/industrial5.png')}
                                                className="d-block w-100 shadow-lg p-1"
                                                alt="..."
                                            />
                                        </div>
                ...
                <div className="row mb-5" style={{ marginTop: 60, backgroundColor: "white" }}>
                    ...
                    <div className="col-xl-6">
                        <div className="r2">
                            ...
                            <br />
                            <p className='fs-5'>
                            In the field of CONSTRUCTION, HVAC and MEP, where precision, agility, reliability and quality are critical aspects for success. <b>Vedanand Constructions</b> is dedicated to deliver only the best.
                                <br />
